...
def next_batch(X, y, batchSize):
    ...
    for i in np.arange(0, X.shape[0], batchSize):
        ...
        # Returen a list, yield: generator, not save, continue
...
ap.add_argument("-n", "--name", type=str, default="sgd", help="name of algorithm")
args = vars(ap.parse_args())              # have dict-like view of the attributes
...
X = np.c_[X, np.ones((X.shape[0]))] # concatenation 
...
plt.ylabel("Loss")
plt.show()
plt.savefig('training_loss_sgd.png') 
